...
class BigBlockTest(BitcoinTestFramework):
    ...
    def setup_chain(self):
        ...
        if not os.path.isdir(os.path.join(CACHE_DIR, "node0")):
            ...
            for i in range(4):
                initialize_datadir(CACHE_DIR, i) # Overwrite port/rpcport in litecoin.conf

            first_block_time = FORK_TIME - 200 * 150
        ...
        for i in range(4):
            ...
            initialize_datadir(self.options.tmpdir, i) # Overwrite port/rpcport in litecoin.conf
